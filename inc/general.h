...
#define fprintf_html_red(stream, str_, ...) fprintf(stream, HTML_RED str_ HTML_BLACK, ##__VA_ARGS__)
#define fprintf_html_grn(stream, str_, ...) fprintf(stream, HTML_GRN str_ HTML_BLACK, ##__VA_ARGS__)
#define fprintf_html_black(stream, str_, ...) fprintf(stream, HTML_BLACK str_ HTML_BLACK, ##__VA_ARGS__)
#define fprintf_html_yel(stream, str_, ...) fprintf(stream, HTML_YEL str_ HTML_BLACK, ##__VA_ARGS__)
